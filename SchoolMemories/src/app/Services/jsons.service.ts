...
export class JsonsService {
  ...
  GetSeventhDayAdventistHigherSecondarySchoolAhmedabadJsonData() {
    return this._HttpClient.get<SeventhDayAdventistHigherSecondarySchoolAhmedabadModel>("/SchoolMemories/Jsons/SeventhDayAdventistHigherSecondarySchoolAhmedabad.json");
  }
}
